...
export default function FarmhouseServicePage() {
  const projects = Object.values(farmhouseProjects);
      ...
      <section className="py-20 sm:py-28 relative overflow-hidden bg-[#FDFCFB]">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16 sm:mb-20">
            ...
            >
              Reclaim your connection with the earth. Explore our carefully curated farmhouse developments, designed to offer high-yielding fertility, tranquil settings, and luxury eco-living.
            </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            {projects.map((project, i) => (
              ...
              >
                <Link href={`/services/farmhouse/${project.slug}`}>
